 ...
 //        });
	...
	$('#robonomics').AnySlide({
		...
		onSliderLoad: function(){
			...
			//set height for content (everything there is absolute positioned)
			var imgContainer = $(this).find('#robonomics-slide');
			var tipContainer = $(this).find('#robonomics-text');

			imgHeight( imgContainer );
			tipHeight( tipContainer );

			$w.on('resize.Robonomics', function(){
				imgHeight( imgContainer );
				tipHeight( tipContainer );
			});
		...
		onSlideChange: function(index){
			...
			//set height for content individually for mobiles

			var tipContainer = $(this).find('#robonomics-text');

			if ($w.width() < mobileScreen){
				tipHeightCur( tipContainer, index );
			}
